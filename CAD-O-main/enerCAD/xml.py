...
def modify_type(district, ground_data, green_data, street_data, green_groundtype=3, road_groundtype=2, green_kfactor=0.7, green_SWR=0.22, road_SWR=0.14):
    ...
    return road_index_list, green_index_list, buffered_streets
